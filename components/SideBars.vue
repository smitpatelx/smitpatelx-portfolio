  ...
  <div class="z-0 hidden lg:flex">
    <div class="flex flex-col w-1/12 justify-center items-center mt-4 fixed left-0 bottom-0 select-none">
      ...
      <div class="flex flex-col w-1/12 justify-center items-center mt-4 fixed right-0 bottom-0 select-none slide-in-bottom">
        <a href="mailto:smitpatel.dev@gmail.com" target="_blank" class="px-2 pt-3 flex flex-wrap justify-center items-center text-center transition-all text-gray-500 hover:text-blue-400 font-mono text-base" style="writing-mode: vertical-rl;text-orientation: mixed;">
