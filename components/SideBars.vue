  ...
  <div class="z-0">
    <div class="flex justify-between px-20 fixed left-0 bottom-0 select-none">
      <div class="flex flex-col w-1/12 justify-center items-center mt-8">
        ...
        <a href="https://www.linkedin.com/in/smitpatelx/" target="_blank" class="text-gray-600 hover:text-teal-400 p-3 rounded-full transition-all">
        ...
        <a href="https://www.instagram.com/netdevv/" target="_blank" class="text-gray-600 hover:text-teal-400 p-3 rounded-full transition-all">
        ...
        <a href="https://twitter.com/smitpatelx" target="_blank" class="text-gray-600 hover:text-teal-400 p-3 rounded-full transition-all">
      ...
      <div class="flex flex-col w-1/12 justify-center items-center mt-4 fixed right-0 bottom-0 select-none">
        <a href="mailto:smitpatel.dev@gmail.com" target="_blank" class="flex flex-wrap justify-center items-center text-center transition-all text-gray-500 hover:text-teal-400 font-mono text-lg" style="writing-mode: vertical-rl;text-orientation: mixed;">
