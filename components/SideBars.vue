<template>
  <div class="z-0 hidden lg:flex">
    <div class="flex flex-col w-1/12 justify-center items-center mt-4 fixed left-0 bottom-0 select-none">
      <div v-scroll-reveal="{ delay: 1200, mobile: false, origin: 'bottom', easing: 'cubic-bezier(0.5, 0, 0, 1)', distance: '180px'}" class="flex flex-col w-1/12 justify-center items-center mt-8 slide-in-bottom">
        <a href="https://github.com/smitpatelx" target="_blank" class="text-gray-600 hover:text-blue-400 p-3 rounded-full transition-all">
        ...
        <a href="https://www.linkedin.com/in/smitpatelx/" target="_blank" class="text-gray-600 hover:text-blue-400 p-3 rounded-full transition-all">
        ...
        <a href="https://www.instagram.com/smit.dev/" target="_blank" class="text-gray-600 hover:text-blue-400 p-3 rounded-full transition-all">
        ...
        <a href="https://twitter.com/smitpatelx" target="_blank" class="text-gray-600 hover:text-blue-400 p-3 rounded-full transition-all">
        ...
        <div class="w-10 block h-48 flex flex-wrap justify-center items-start mt-6">
          <div class="bg-blue-400 h-full" style="width:1px;"></div>
        </div>
      </div>
      <div v-scroll-reveal="{ delay: 1200, mobile: false, origin: 'bottom', easing: 'cubic-bezier(0.5, 0, 0, 1)', distance: '180px'}" class="flex flex-col w-1/12 justify-center items-center mt-4 fixed right-0 bottom-0 select-none slide-in-bottom">
        <a href="mailto:smitpatel.dev@gmail.com" target="_blank" class="px-2 pt-3 flex flex-wrap justify-center items-center text-center transition-all text-gray-600 hover:text-blue-400 font-mono text-base" style="writing-mode: vertical-rl;text-orientation: mixed;">
          smitpatel.dev@gmail.com
        </a>
        <div class="w-10 block h-48 flex flex-wrap justify-center items-end mt-6">
          <div class="bg-blue-400 h-full" style="width:1px;"></div>
        </div>
      </div>
    </div>
...
.resume_button{
  @apply bg-transparent px-6 py-3 ml-10 text-blue-400 border border-blue-400 rounded-md text-lg;
