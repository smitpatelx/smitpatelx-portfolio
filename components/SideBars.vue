  ...
  <div class="z-0">
    <div class="flex justify-between px-20 fixed left-0 bottom-0 select-none">
      <div class="flex flex-col w-1/12 justify-center items-center mt-8">
        ...
        <div class="w-10 block h-64 flex flex-wrap justify-center items-start mt-6">
          <div class="bg-teal-400 h-full" style="width:1px;"></div>
        </div>
      </div>
      <div class="flex flex-col w-1/12 justify-center items-center mt-4 fixed right-0 bottom-0 select-none">
        <a href="mailto:smitpatel.dev@gmail.com" target="_blank" class="w-10 flex flex-wrap justify-center items-center my-3 transition-all text-gray-500 hover:text-teal-400 font-mono text-lg" style="writing-mode: vertical-rl;text-orientation: mixed;">
          smitpatel.dev@gmail.com
        </a>
        <div class="w-10 block h-64 flex flex-wrap justify-center items-end mt-6">
          <div class="bg-teal-400 h-full" style="width:1px;"></div>
        </div>
      </div>
    </div>
...
.resume_button{
  @apply bg-transparent px-6 py-3 ml-10 text-teal-400 border border-teal-400 rounded-md text-lg;
