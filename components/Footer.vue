    ...
    <div class="w-full flex flex-wrap items-center justify-start bg-gray-200 clip-path-1 relative">
      <div class="container mx-auto pt-32 pb-24">
        <div class="w-full flex flex-wrap items-start justify-center content-center">
          ...
          <div class="w-full text-center absolute bottom-0 py-3 px-10 md:px-52 flex flex-wrap justify-between items-center">
            <span class="text-base text-gray-500">Copyright 2020 - Smit Patel</span>
            <div class="flex flex-wrap items-center justify-center">  
              <a href="https://github.com/smitpatelx" target="_blank" class="text-gray-500 hover:text-gray-600 p-1 rounded-full transition-all">
              ...
              <a href="https://www.linkedin.com/in/smitpatelx/" target="_blank" class="text-gray-500 hover:text-gray-600 p-1 rounded-full transition-all">
              ...
              <a href="https://www.instagram.com/smit.dev/" target="_blank" class="text-gray-500 hover:text-gray-600 p-1 rounded-full transition-all">
              ...
              <a href="https://twitter.com/smitpatelx" target="_blank" class="text-gray-500 hover:text-gray-600 p-1 rounded-full transition-all">
