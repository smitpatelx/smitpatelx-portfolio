<template>
    <div class="w-full">
        <slide-y-down-transition>
            <nuxt-link v-if="isVisible" to="/" @click.native="scrollUp" class="w-10 h-10 bg-teal-500 hover:bg-teal-400 text-white hover:text-teal-800 trans-1 flex flex-wrap justify-center items-center fixed bottom-0 right-0 mr-10 lg:mr-24 mb-10 focus:outline-none focus:shadow-outline">
