        ...
        <div class="max-w-2xl flex flex-wrap justify-start items-center cursor-default">
            ...
            <div class="w-full h-full flex flex-wrap mt-2">
                <div class="w-full flex flex-wrap items-center justify-center">
                    <div class="mb-4 bg-gray-700 rounded-full flex flex-wrap items-center justify-center leading-none gap-3">
                ...
                <div class="w-full relative antialiased" style="min-height: 80vh;">
                    <transition name="zoom-in">
                        <div :key="0" v-if="!current_company" class="w-full flex flex-wrap flex-col pl-4 mt-6 lg:mt-0">
                            <div class="w-full flex flex-wrap flex-col items-center justify-center">
                                <p class="text-xl font-secondary text-gray-800">Full-stack Developer <span class="pl-2 text-teal-s whitespace-no-wrap">@ Netdevv</span></p>
                        ...
                        <div :key="1" v-if="current_company" class="w-full flex flex-wrap flex-col pl-4 mt-6 lg:mt-0">
                            <div class="w-full flex flex-wrap flex-col items-center justify-center">
                                <p class="text-xl font-secondary text-gray-800">Director of Web Development<span class="pl-2 text-teal-s whitespace-no-wrap">@ Blabbly</span></p>
...
.text-nav {
 @apply w-auto self-center text-gray-100 border border-transparent transition-all duration-300 ease-linear text-base tracking-wider shadow-none py-2 px-3 rounded-full leading-none;

    &:focus{
        @apply outline-none select-none shadow-md bg-teal-s text-gray-100;
    }
}
