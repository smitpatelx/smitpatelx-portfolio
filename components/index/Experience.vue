    ...
    <div class="w-full min-h-screen flex flex-wrap justify-center items-center mt-10 lg:mt-0 p-10 lg:p-32 mb-10" id="experience">
        <div class="max-w-2xl flex flex-wrap justify-start items-center cursor-default">
            ...
            <div class="w-full h-full flex flex-wrap mt-8">
                <div v-scroll-reveal="{ delay: 400, mobile: false, origin: 'bottom', easing: 'cubic-bezier(0.5, 0, 0, 1)', distance: '80px'}" class="relative w-full lg:w-1/5 text-gray-600 flex flex-wrap flex-row lg:flex-col items-center justify-start font-mono tracking-tight text-sm">
