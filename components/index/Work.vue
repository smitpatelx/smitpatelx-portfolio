        ...
        <div class="flex flex-wrap justify-start items-center cursor-default work-w">
            ...
            <div class="w-full h-full flex flex-wrap mt-8 py-10 justify-center items-center">
                ...
                <div class="w-full flex flex-wrap relative justify-end rounded mb-10" >
                    <a href="https://4unaturalistic.com/" target="_blank" v-lazy-container="{ selector: 'img' }" class="w-full md:w-1/2 md:h-full z-0 rounded flex justify-center items-center shadow-xl">
                    ...
                    <div class="w-full md:w-1/2 z-10 flex flex-wrap flex-col justify-start items-end py-5 md:min-h-full">
                ...
                <div class="w-full flex flex-wrap-reverse md:flex-wrap relative justify-end rounded mb-10" >
                    <div class="w-full md:w-1/2 z-10 flex flex-wrap flex-col justify-start items-start py-5 md:min-h-full">
                        <h3 class="font-mono text-blue-400 text-sm text-right">Featured Project</h3>
                    ...
                    <a href="https://4unaturalistic.netlify.app" target="_blank" v-lazy-container="{ selector: 'img' }" class="w-full md:w-1/2 md:h-full z-0 rounded flex justify-center items-center shadow-xl">
                ...
                <!-- Project 3 - Start -->
                <div class="w-full flex flex-wrap relative justify-end rounded mb-10" >
                    <a href="https://avenest.smitpatelx.com" target="_blank" v-lazy-container="{ selector: 'img' }" class="w-full md:w-1/2 md:h-full z-0 rounded flex justify-center items-center shadow-xl">
                ...
                <div class="w-full flex flex-wrap-reverse md:flex-wrap relative justify-end rounded mb-10" >
                    ...
                    <a href="https://snapi.netlify.app/" target="_blank" v-lazy-container="{ selector: 'img' }" class="w-full md:w-1/2 md:h-full z-0 rounded flex justify-center items-center shadow-xl">
                ...
                <!-- Project 5 - Start -->
                <div class="w-full flex flex-wrap relative justify-end rounded mb-10" >
                    <a href="https://dcwebd.netlify.app/" target="_blank" v-lazy-container="{ selector: 'img' }" class="w-full md:w-1/2 md:h-full z-0 rounded flex justify-center items-center shadow-xl">
