<template>
    <div class="w-full flex flex-wrap justify-center items-center min-h-screen bg-apps pb-24 md:pb-0">
        ...
        <div v-scroll-reveal="{ delay: 500, mobile: true, origin: 'center', easing: 'cubic-bezier(0.5, 0, 0, 1)', scale: 0}" class="w-full flex flex-wrap justify-center items-center pt-10 md:pt-0">
            <nuxt-link to="/apps" class="base-btn bg-gray-300 text-gray-800">
