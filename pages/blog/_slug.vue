<template>
  <div class="w-full flex flex-wrap py-10 invert container mx-auto z-10" >
    <div class="flex w-full flex-wrap justify-center items-start z-10">
      ...
      <article class="w-full m-0 px-5 md:px-8 py-16 bg-blue-100 bg-opacity-50 rounded-none md:rounded-xl">
        <h1 class="font-bold text-6xl pb-6 text-gray-800">{{blog.title}}</h1>
