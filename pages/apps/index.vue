<template>
    <div class="w-full flex flex-col md:flex-row flex-wrap items-stretch justify-center py-10">
        ...
        <div class="max-w-4xl px-6 lg:px-10 py-10 flex flex-wrap relative items-start justify-center">
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div v-scroll-reveal="{ delay: i*100, mobile: false, origin: 'top', easing: 'ease-in', distance: '40px' }" v-for="(app, i) in apps" :key="i" class="w-full rounded-lg duration-300 transition-all flex flex-wrap items-stretch justify-center shadow-xl bg-white">
                    <div class="w-full flex flex-wrap items-center justify-center py-5 rounded-t-md md:rounded-t-lg card-img" v-lazy-container="{ selector: 'img' }">
                    ...
                    <div class="px-8 pb-8 rounded-b-md md:rounded-b-lg w-full">
                        ...
                        <p class="text-xl text-gray-700 leading-tight my-2">{{app.description | desc}}</p>
...
.btn-secondary{
    @apply bg-transparent text-blue-500 p-1 rounded-md text-lg font-semibold flex flex-wrap justify-center items-center text-center transition-all duration-300;
    transition: all 0.4s;
    & > svg {
  ...
  &:focus{
    @apply transition-all duration-300 ease-in-out outline-none shadow-outline;
    & > svg {
        @apply ml-2 transition-all duration-300;
    }
  }
