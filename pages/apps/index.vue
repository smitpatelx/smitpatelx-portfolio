<template>
    <div class="w-full flex flex-col md:flex-row flex-wrap items-stretch justify-center py-4" style="z-index:20;">
        <div class="px-6 lg:px-10 pb-10 flex flex-wrap relative items-start justify-center" style="z-index:20;">
            <div class="w-full h-16 flex flex-wrap items-start justify-center mb-4 px-4" style="z-index:20;">
                <span style="z-index:20;" class="font-bold text-4xl text-gray-100" v-scroll-reveal="{ delay: 100, mobile: true, origin: 'top', easing: 'cubic-bezier(0.5, 0, 0, 1)', distance: '80px'}">Apps</span>
            </div>
            ...
            <div class="w-full flex flex-wrap gap-y-4 md:gap-8 justify-center items-center">
                <div v-for="(app, i) in apps" :key="i" class="w-full md:max-w-sm rounded-lg duration-300 transition-all flex flex-col items-stretch justify-start shadow-xl bg-white">
                    ...
                    <div class="px-4 pb-6 rounded-b-md md:rounded-b-lg w-full felx-1 felx items-stretch justify-start">
...
.btn-secondary{
    @apply bg-transparent text-gray-700 py-1 px-3 leading-none rounded-full text-lg font-semibold flex flex-wrap justify-center items-center text-center border-2 border-transparent transition-all duration-300 ease-in-out;
    & > svg {
  ...
  &:focus{
    @apply transition-all duration-300 ease-in-out outline-none border-blue-300 text-gray-600;
    & > svg {
        @apply ml-2 transition-all duration-300;
    }
  }
