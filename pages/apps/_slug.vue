<template>
  <div class="w-full flex flex-wrap py-10 bg-gray-100 invert" v-lazy-container="{ selector: 'img' }">
    ...
    <div class="px-0 md:px-6 lg:px-10 w-full flex flex-wrap justify-center items-center">
