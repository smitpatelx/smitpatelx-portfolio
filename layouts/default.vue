...
<script>
import HeroGradient from "@/components/library/hero-gradient.vue";
...
.zoom-in-leave-active {
    animation: zoom-in .3s reverse ease-in-out;
}

@keyframes zoom-in {
    0% {
        transform: scale(0) translateX(80%);
    }
    100% {
